        ...
        return (
          <div key={`${participant.summoner_name}-${perk_int}`}>
            {perks.map((perk_id, key) => {
              ...
              const is_perk_selected = participant.stats[`stat_perk_${perk_int}`] === perk_id
              ...
              return (
                <div key={`${perk_id}-${key}`} style={{display: 'inline-block'}}>
                  <div data-tip={perk.name} style={{...perk_style}}>
                    <img style={{...image_style}} src={statmods[perk_id].image_url} alt="" />
                  </div>
                </div>
              )
            })}
