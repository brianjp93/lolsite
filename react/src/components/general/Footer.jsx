...
function footer(props) {
    return (
        <div>
            ...
            >
                <div
                    className={`${props.store.state.theme} plain`}
                    style={{
                        position: 'absolute',
                        bottom: 0,
                        right: 0,
                ...
                >
                    ...
                    >
                        <div>
                            <em>{props.store.state.project_title}</em> isn’t
                            endorsed by Riot Games and doesn’t reflect the views
                            or opinions of Riot Games or anyone officially
