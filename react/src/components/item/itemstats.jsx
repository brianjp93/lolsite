    ...
    <Skeleton {...props}>
      <div className="row" style={{marginBottom: 0}}>
        <div style={{display: 'flex', flexWrap: 'wrap'}} className="col l10 offset-l1">
          ...
          <EffectiveDamage theme={theme} style={card_styles} width={500} height={500} />
        </div>
      </div>
    </Skeleton>
  )
...
export function ArmorCuttingCard(props) {
  ...
  return (
    <div style={{...style}}>
      ...
      >
        The graph above shows the % Damage increase (y-axis) you get from each item, depening on the
        enemy's armor (x-axis).
      </div>
    </div>
  )
}
