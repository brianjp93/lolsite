...
describe('utils/colorManipulator', function () {
  ...
  describe('rgbToHex', function () {
    it('converts an rgb color to a hex color` ', function () {
      _chai.assert.strictEqual((0, _colorManipulator.rgbToHex)('rgb(169, 79, 211)'), '#a94fd3');
    });

    it('passes a hex value through` ', function () {
      _chai.assert.strictEqual((0, _colorManipulator.rgbToHex)('#A94FD3'), '#A94FD3');
    });
  });
  ...
  describe('getLuminance', function () {
    it('returns a valid luminance for rgb black', function () {
...
//# sourceMappingURL=colorManipulator.test.js.map