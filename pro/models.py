...
class LeagueAbout(models.Model):
    league = models.ForeignKey(
        "League", related_name="abouts", on_delete=models.CASCADE
    )
...
class LeagueTournament(models.Model):
    league = models.ForeignKey(
        "League", related_name="tournaments", on_delete=models.CASCADE
    )
...
class TournamentRoster(models.Model):
    tournament = models.ForeignKey(
        "LeagueTournament", related_name="rosters", on_delete=models.CASCADE
    )
    _id = models.CharField(max_length=128, default="", blank=True)
    name = models.CharField(max_length=32, default="", blank=True)
...
class TournamentBreakpoint(models.Model):
    tournament = models.ForeignKey(
        "LeagueTournament", related_name="breakpoints", on_delete=models.CASCADE
    )
    _id = models.CharField(max_length=128, default="", blank=True)
...
class BreakpointInput(models.Model):
    breakpoint = models.ForeignKey(
        "TournamentBreakpoint", related_name="inputs", on_delete=models.CASCADE
    )
    roster = models.ForeignKey(
        "TournamentRoster", related_name="breakpointinputs", on_delete=models.CASCADE
    )
...
class BreakpointStandings(models.Model):
    breakpoint = models.OneToOneField(
        "TournamentBreakpoint", related_name="standings", on_delete=models.CASCADE
    )
...
class StandingResult(models.Model):
    standing = models.ForeignKey(
        "BreakpointStandings", related_name="results", on_delete=models.CASCADE
    )
    sort_int = models.IntegerField(default=0)
    roster = models.ForeignKey(
        "TournamentRoster", related_name="standingresults", on_delete=models.CASCADE
    )
...
class TournamentBracket(models.Model):
    tournament = models.ForeignKey(
        "LeagueTournament", related_name="brackets", on_delete=models.CASCADE
    )
    _id = models.CharField(max_length=128, default="", blank=True)
    name = models.CharField(max_length=128, default="", blank=True)
...
class BracketInput(models.Model):
    bracket = models.ForeignKey(
        "TournamentBracket", related_name="inputs", on_delete=models.CASCADE
    )
    roster = models.ForeignKey(
        "TournamentRoster", related_name="bracketinputs", on_delete=models.CASCADE
    )
    breakpoint = models.ForeignKey(
        "TournamentBreakpoint", related_name="bracketinputs", on_delete=models.CASCADE
    )
...
class BracketMatch(models.Model):
    bracket = models.ForeignKey(
        "TournamentBracket", related_name="matches", on_delete=models.CASCADE
    )
...
class MatchInput(models.Model):
    match = models.ForeignKey(
        "BracketMatch", related_name="inputs", on_delete=models.CASCADE
    )
    roster = models.ForeignKey(
        "TournamentRoster", related_name="matchinputs", on_delete=models.CASCADE
    )
    breakpoint = models.ForeignKey(
        "TournamentBreakpoint", related_name="matchinputs", on_delete=models.CASCADE
    )
...
class MatchGame(models.Model):
    match = models.ForeignKey(
        "BracketMatch", related_name="games", on_delete=models.CASCADE
    )
    match_model = models.OneToOneField(
        "match.Match", null=True, on_delete=models.SET_NULL, blank=True
    )
    _id = models.CharField(max_length=128, default="", blank=True)
    name = models.CharField(max_length=128, default="", blank=True)
...
class GameInput(models.Model):
    game = models.ForeignKey(
        "MatchGame", related_name="games", on_delete=models.CASCADE
    )
    roster = models.ForeignKey(
        "TournamentRoster", related_name="gameinputs", on_delete=models.CASCADE
    )
    breakpoint = models.ForeignKey(
        "TournamentBreakpoint", related_name="gameinputs", on_delete=models.CASCADE
    )
    standing = models.IntegerField(default=0)
...
class MatchDetails(models.Model):
    match = models.OneToOneField(
        "BracketMatch", related_name="details", on_delete=models.CASCADE
    )


class Mapping(models.Model):
    details = models.ForeignKey(
        "MatchDetails", related_name="mappings", on_delete=models.CASCADE
    )
...
class Team(models.Model):
    details = models.ForeignKey(
        "MatchDetails", related_name="teams", on_delete=models.CASCADE
    )
...
class MatchPlayer(models.Model):
    details = models.ForeignKey(
        "MatchDetails", related_name="players", on_delete=models.CASCADE
    )
...
class ScheduleItem(models.Model):
    details = models.ForeignKey(
        "MatchDetails", related_name="scheduleitems", on_delete=models.CASCADE
    )
    _id = models.CharField(max_length=128, default="", blank=True)
...
class Video(models.Model):
    details = models.ForeignKey(
        "MatchDetails", related_name="videos", on_delete=models.CASCADE
    )
